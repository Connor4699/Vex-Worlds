...
namespace enc {
	pros::ADIEncoder right(7, 8, false);
	pros::ADIEncoder left(5, 6, true);
	pros::ADIEncoder back(3, 4, true);
}
...
namespace motor {
	...
	pros::Motor back_claw(15, pros::E_MOTOR_GEARSET_36, false, pros::E_MOTOR_ENCODER_COUNTS);
}
